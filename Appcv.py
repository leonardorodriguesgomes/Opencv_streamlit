...
def principal():
    ...
    st.subheader('Este aplicativo web permite integrar processamento de imagens com OpenCV')
    ...
    if filtro_aprimoramento:
        imagem_processada = melhorada_detalhe(imagem_processada)
    if img_cinza:
